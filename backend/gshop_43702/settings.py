"""
Django settings for gshop_43702 project.
...
WSGI_APPLICATION = 'gshop_43702.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gshop_43702 API",
    "DESCRIPTION": "API documentation for gshop_43702 App",
    "VERSION": "v1",
}
